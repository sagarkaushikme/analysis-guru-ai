      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-10">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-card sm:p-8">
          ...
          <Button variant="outline" className="w-full">
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24"><path fill="#EA4335" d="M12 11v2.8h6.5c-.3 1.6-1.9 4.7-6.5 4.7-3.9 0-7.1-3.2-7.1-7.2S8.1 4 12 4c2.2 0 3.7.9 4.6 1.7l3.1-3C17.7 1 15.1 0 12 0 5.4 0 0 5.4 0 12s5.4 12 12 12c6.9 0 11.5-4.9 11.5-11.7 0-.8-.1-1.4-.2-2H12z"/></svg>
