...
export const Route = createFileRoute("/signup")({
  head: () => ({ meta: [{ title: "Sign up — TradeAI" }, { name: "description", content: "Create a free TradeAI account — 2 analyses free." }] }),
  component: Signup,
});
...
function Signup() {
  ...
  return <AuthShell mode="signup">
    <form onSubmit={submit} className="space-y-4">
      <div className="space-y-2"><Label htmlFor="name">Name</Label><Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" /></div>
