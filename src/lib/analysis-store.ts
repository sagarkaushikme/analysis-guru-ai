...
export const DUMMY_ANALYSIS: Analysis = {
  ...
  bullish_scenario: "Agar 45300 ke upar close ho toh target 45480-45680 possible",
  bearish_scenario: "45080 toot gaya toh 44800 tak gir sakta hai — turat exit karo",
  mistakes: ["Late breakout entry", "Risk too high", "FOMO detected", "Overleveraged"],
  action_points: [
    "45300 ke upar hold rakho",
    "45080 pe exit",
    "Position 2% rakho",
    "9:30am volume dekho",
    "Expiry week cautious",
  ],
  summary: "Setup solid hai. Bullish engulfing support pe strong signal hai. Position size kam karo.",
  emotion_detected: "FOMO",
  risk_level: "medium-high",
  roast: "Bhai ye trade FOMO lag raha hai — price pehle se 2% upar tha aur tune tab entry li?",
  trader_iq: 74,
  ai_confidence: 82,
